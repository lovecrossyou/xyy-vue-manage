        ...
        >
          ...
          <el-row v-if="foodSpecs == 'one'">
            ...
            <el-form-item label="爱心捐助">
              <el-input-number
                v-model="foodForm.specs[0].donate_amount"
                :min="0"
                :precision="2"
                :step="0.01"
              ></el-input-number>
          ...
          <el-row v-else style="overflow: auto; text-align: center;">
            ...
            >
              ...
              <el-table-column prop="donate_amount" label="爱心捐助"></el-table-column>
        ...
        <el-dialog title="添加规格" v-model="dialogFormVisible">
          <el-form :rules="specsFormrules" :model="specsForm">
            ...
            <el-form-item label="包装费" label-width="100px">
              <el-input-number v-model="specsForm.packing_fee" :precision="2" :step="0.1"></el-input-number>
            </el-form-item>
